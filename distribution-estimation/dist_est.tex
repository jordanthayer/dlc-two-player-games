...
\begin{slide}{Distribution Estimation}
  \onslide*{1}{\includegraphics[width=\textwidth]{images/one_bandit.eps}}
  %% First payout
  \onslide*{2}{\includegraphics[width=\textwidth]{images/discret_dist_1.eps}}
  %% second payout
  \onslide*{3}{\includegraphics[width=\textwidth]{images/discret_dist_2.eps}}
  %% third payout, same as first
  \onslide*{4}{\includegraphics[width=\textwidth]{images/discret_dist_3.eps}}
  %% ...
  %% Hey look it's a distribution!
  \onslide*{5}{\includegraphics[width=\textwidth]{images/discret_dist_end.eps}}
  \onslide*{6}{\includegraphics[width=\textwidth]{images/discret_dist_as_dist.eps}}
\end{slide}
